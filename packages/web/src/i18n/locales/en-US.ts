...
const enUS = {
  ...
  'employees.columnActions': 'Actions',
  'employees.statusActive': 'Active',
  'employees.statusSuspended': 'Suspended',
  'employees.suspend': 'Suspend',
  'employees.activate': 'Activate',
  'employees.suspended': 'Employee suspended',
  'employees.activated': 'Employee activated',
  'employees.roleChanged': 'Role changed',
  'employees.delete': 'Delete',
  'employees.deleted': 'Employee deleted',
  'employees.deleteConfirm': 'Delete this employee?',
  'employees.selfDisabled': "You can't change your own account here",
